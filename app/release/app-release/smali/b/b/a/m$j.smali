...
.method public constructor <init>(Lb/b/a/m;)V
    ...
    iput-object p1, p0, Lb/b/a/m$j;->b:Lb/b/a/m;
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    iget-object p1, p0, Lb/b/a/m$j;->b:Lb/b/a/m;
    ...
    const-string p2, "/system/xbin/busybox sed -i \'/string name=\"kilobyte_per_second\"/d\' /data/system/theme/theme_values.xml"

    invoke-static {p2, p1}, La/b/k/r;->a(Ljava/lang/String;Z)Lb/b/a/l;

    const-string p2, "/system/xbin/busybox  sed -i \"s/<MIUI_Theme_Values>/&\\n    <string name=\\\"kilobyte_per_second\\\">K\'s<\\/string>/\" /data/system/theme/theme_values.xml"
    ...
    const-string p2, "/system/xbin/busybox sed -i \'/string name=\"kilobyte_per_second\"/d\' /data/system/theme/nightmode/theme_values.xml"

    invoke-static {p2, p1}, La/b/k/r;->a(Ljava/lang/String;Z)Lb/b/a/l;

    const-string p2, "/system/xbin/busybox  sed -i \"s/<MIUI_Theme_Values>/&\\n    <string name=\\\"kilobyte_per_second\\\">K\'s<\\/string>/\" /data/system/theme/nightmode/theme_values.xml"

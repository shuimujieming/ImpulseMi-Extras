...
.field public static final j:La/b/p/n0$c;
...
.method public static constructor <clinit>()V
    ...
    new-instance v0, La/b/p/n0$c;

    const/4 v1, 0x6

    invoke-direct {v0, v1}, La/b/p/n0$c;-><init>(I)V

    sput-object v0, La/b/p/n0;->j:La/b/p/n0$c;
...
.method public static declared-synchronized a()La/b/p/n0;
    .locals 4
    ...
    new-instance v2, La/b/p/n0$f;

    invoke-direct {v2}, La/b/p/n0$f;-><init>()V

    const-string v3, "vector"

    invoke-virtual {v1, v3, v2}, La/b/p/n0;->a(Ljava/lang/String;La/b/p/n0$d;)V

    new-instance v2, La/b/p/n0$b;

    invoke-direct {v2}, La/b/p/n0$b;-><init>()V

    const-string v3, "animated-vector"

    invoke-virtual {v1, v3, v2}, La/b/p/n0;->a(Ljava/lang/String;La/b/p/n0$d;)V

    new-instance v2, La/b/p/n0$a;

    invoke-direct {v2}, La/b/p/n0$a;-><init>()V
...
.method public static declared-synchronized a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    :try_start_0
    sget-object v1, La/b/p/n0;->j:La/b/p/n0$c;
    ...
    sget-object p0, La/b/p/n0;->j:La/b/p/n0$c;
    ...
    invoke-virtual {p0, p1, v1}, La/d/f;->a(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static a(Landroid/graphics/drawable/Drawable;La/b/p/v0;[I)V
    .locals 3
    ...
    invoke-static {p2, p1}, La/b/p/n0;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method public final a(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 2
    invoke-virtual {p0, p1, v3, v4}, La/b/p/n0;->a(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    iget-object v1, p0, La/b/p/n0;->g:La/b/p/n0$e;
    ...
    invoke-virtual {p0, p1, v6}, La/b/p/n0;->b(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p1, v1}, La/b/p/n0;->b(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method public declared-synchronized a(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
    ...
    .line 13
    :goto_1
    invoke-virtual {p0, p1, p2}, La/b/p/n0;->d(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    if-nez v0, :cond_3

    invoke-virtual {p0, p1, p2}, La/b/p/n0;->a(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p1, p2, p3, v0}, La/b/p/n0;->a(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
...
.method public final a(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p1, p2}, La/b/p/n0;->c(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    :cond_0
    invoke-static {p4}, La/b/k/r;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;

    move-result-object p4

    invoke-static {p4, v0}, La/b/k/r;->a(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V

    .line 24
    iget-object p1, p0, La/b/p/n0;->g:La/b/p/n0$e;
    ...
    .line 26
    invoke-static {p4, v1}, La/b/k/r;->a(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V

    goto/16 :goto_4

    :cond_3
    iget-object v0, p0, La/b/p/n0;->g:La/b/p/n0$e;
    ...
    .line 29
    invoke-virtual {v0, v6, v7, v8}, La/b/p/j$a;->a(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    .line 31
    invoke-virtual {v0, v5, v6, v7}, La/b/p/j$a;->a(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    .line 33
    invoke-virtual {v0, v2, v4, v5}, La/b/p/j$a;->a(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    .line 36
    :cond_8
    invoke-virtual {p0, p1, p2, p4}, La/b/p/n0;->a(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
...
.method public declared-synchronized a(La/b/p/n0$e;)V
    .locals 0

    monitor-enter p0

    :try_start_0
    iput-object p1, p0, La/b/p/n0;->g:La/b/p/n0$e;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final a(Ljava/lang/String;La/b/p/n0$d;)V
    .locals 1
    ...
    iput-object v0, p0, La/b/p/n0;->b:La/d/a;
...
.method public a(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-static {p1, v3}, La/b/p/j;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method public declared-synchronized b(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    :try_start_0
    invoke-virtual {p0, p1, p2, v0}, La/b/p/n0;->a(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
...
.method public final d(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 8
    invoke-virtual {p0, p1, v4, v5}, La/b/p/n0;->a(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v3, p1, v1, v7, v8}, La/b/p/n0$d;->a(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
